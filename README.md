...
[![Release](https://img.shields.io/github/v/release/latest-debs/fzf-debian)](https://github.com/latest-debs/fzf-debian/releases)
[![Build](https://github.com/latest-debs/fzf-debian/actions/workflows/release.yml/badge.svg)](../../actions)

[fzf](https://github.com/junegunn/fzf) — a command-line fuzzy finder — packaged for
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/fzf-debian/releases) page:

```sh
sudo apt install ./fzf_*.deb
```
...
Run the [Build fzf for Debian](../../actions) workflow on GitHub with the
...
For issues with fzf itself, see
